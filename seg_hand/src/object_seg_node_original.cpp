...
public:
    ...
    void callback(const PointCloud2ConstPtr& point_cloud_msg, const PointCloud2ConstPtr& hand_point_cloud_msg)
    {
        ...
        try
        {
           ...
           //cout << point_cloud_msg -> header;
           //object_point_cloud->header.frame_id = "/camera_color_optical_frame";
    ...
    pcl::PointCloud<pcl::PointXYZ> seg_hand_out(boost::shared_ptr<pcl::PointCloud<pcl::PointXYZ> > scene_point_cloud, boost::shared_ptr<pcl::PointCloud<pcl::PointXYZ> > hand_point_cloud) 
    {
        ...
        range_cond->addComparison (pcl::FieldComparison<pcl::PointXYZ> ::ConstPtr (new pcl::FieldComparison<pcl::PointXYZ> ("x", pcl::ComparisonOps:: GT, -0.04)));
        range_cond->addComparison (pcl::FieldComparison<pcl::PointXYZ> ::ConstPtr (new pcl::FieldComparison<pcl::PointXYZ> ("x", pcl::ComparisonOps:: LT, 0.05)));
